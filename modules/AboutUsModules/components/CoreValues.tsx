...
const CoreValues = () => {
  ...
  return (
    <main className="relative overflow-hidden min-h-screen flex flex-col justify-center  items-center py-12 sm:py-24">
      ...
      <div className="absolute -bottom-72 inset-0 sm:hidden  -z-10">
        <Image
          src={"/core-values-mobile.svg"}
          alt="Line"
          fill
      ...
      <div className="my-3 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
        {contents.map(({ title, description }, index) => (
          <div
            key={index}
            className="rounded-2xl w-[16rem] lg:w-[25rem] lg:h-[12.438rem] bg-gradient-to-br from-secondary-3 to-secondary-1 px-5 py-5 lg:py-3 text-center"
          >
