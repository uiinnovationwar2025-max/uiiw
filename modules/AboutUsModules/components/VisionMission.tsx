const VisionMission = () => {
  return (
    <main className="relative min-h-screen w-full overflow-hidden">
      <div className="px-20 py-24 gap-8 md:gap-48 lg:px-72 z-10 bg-contain md:bg-cover bg-center bg-no-repeat bg-[url('/visi-misi/bg-mobile.png')] md:bg-[url('/visi-misi/bg.png')] flex flex-col items-center justify-center min-h-screen  ">
        <div className=" text-center">
          <h1 className="text-white font-visby text-4xl md:text-6xl md:mb-12 max-md:mb-4 ">
            Our Vision
          </h1>
          <p className="text-white text-start text-sm md:text-2xl font-questrial mx-auto">
